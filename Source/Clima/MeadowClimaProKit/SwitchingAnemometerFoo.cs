...
namespace Meadow.Foundation.Sensors.Weather
{
    ...
    /// </summary>
    public partial class SwitchingAnemometerFoo :
        ObservableBase<Speed>, IAnemometer
    {
        ...
        public SwitchingAnemometerFoo(IDigitalInputController device, IPin digitalInputPin)
            : this(device.CreateDigitalInputPort(
                digitalInputPin, InterruptMode.EdgeFalling,
                ResistorMode.InternalPullUp, TimeSpan.FromMilliseconds(20), TimeSpan.FromMilliseconds(20)))
        {
        }
        ...
        public SwitchingAnemometerFoo(IDigitalInputPort inputPort)
        {
